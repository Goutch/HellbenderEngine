...
public:
	...
	static void init() {
		...
		ShaderInfo miss_occlusion_shader_info{};
		miss_occlusion_shader_info.stage = SHADER_STAGE_RAY_MISS;
		miss_occlusion_shader_info.path = "shaders/raytracing/miss_occlusion.glsl";
		Shader *miss_occlusion_shader = Resources::createShader(miss_occlusion_shader_info, "miss_occlusion");
		...
		ShaderInfo closest_hit_ao_shader_info{};
		closest_hit_ao_shader_info.path = "shaders/raytracing/closest_hit_occlusion.glsl";
		closest_hit_ao_shader_info.stage = SHADER_STAGE_CLOSEST_HIT;
		Shader *closest_hit_ao_shader = Resources::createShader(closest_hit_ao_shader_info, "closest_hit_occlusion");


		std::vector<Shader *> miss_shaders = {miss_shader,
											  miss_occlusion_shader};
		std::vector<Shader *> hit_shaders{closest_hit_shader,
										  closest_hit_ao_shader,
		...
		acceleration_structure_instances.push_back(
				AccelerationStructureInstance{0, 0, transform_aabb_floor.world(), ACCELERATION_STRUCTURE_TYPE_AABB});
