...
namespace HBE {
	VK_PipelineLayout::VK_PipelineLayout(VK_Device *device, std::vector<VK_Shader *> shaders) {
	...
	void VK_PipelineLayout::createDescriptorSets() {
		...
		std::sort(descriptor_set_layout_bindings.begin(), descriptor_set_layout_bindings.end(), [](VkDescriptorSetLayoutBinding i, VkDescriptorSetLayoutBinding j){return (i.binding < j.binding);});
