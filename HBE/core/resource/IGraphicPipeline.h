...
namespace HBE {
    ...
    public:
        ...
        virtual void setShaders(const Shader *vertex, const Shader *fragment) = 0;

        virtual void setShaders(const Shader *vertex, const Shader *geometry, const Shader *fragment) = 0;
