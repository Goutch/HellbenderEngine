...
namespace HBE
{
	...
	VK_Buffer::VK_Buffer(VK_Device* device, const void* data, VkDeviceSize size, VkBufferUsageFlags usage, MEMORY_TYPE_FLAGS flags, VkDeviceSize custom_alignment) : VK_Buffer(
	...
	void VK_Buffer::alloc(VkDeviceSize size, VkBufferUsageFlags usage, MEMORY_TYPE_FLAGS flags, VkDeviceSize custom_alignment)
	{
	...
	void VK_Buffer::alloc(const void* data, VkDeviceSize size, VkBufferUsageFlags usage, MEMORY_TYPE_FLAGS flags, VkDeviceSize custom_alignment)
	{
		alloc(size, usage, flags, custom_alignment);
		update(data);
	}
