...
namespace HBE {
	void VK_Fence::alloc(VK_Context *context, const FenceInfo &info) {
	...
	FENCE_STATUS VK_Fence::getStatus() {
		FENCE_STATUS status = FENCE_STATUS_READY;
		getStatus(status);
		return status;
	}
