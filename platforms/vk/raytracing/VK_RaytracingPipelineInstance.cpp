...
namespace HBE
{
    VK_RaytracingPipelineInstance::VK_RaytracingPipelineInstance(VK_Context* context, const RaytracingPipelineInstanceInfo& info)
    {
    ...
    {
        descriptors->setAccelerationStructure(binding, reinterpret_cast<const VK_TopLevelAccelerationStructure*>(accelerationStructure), frame);
    }
    ...
    {
        descriptors->setAccelerationStructure(descriptors->getBinding(name), reinterpret_cast<const VK_TopLevelAccelerationStructure*>(accelerationStructure), frame);
    }
