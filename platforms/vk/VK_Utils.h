...
namespace HBE
{
	...
	{
	public:
		static std::string samplerModeToString(TEXTURE_SAMPLER_ADDRESS_MODE mode)
        {
            switch (mode)
            {
		...
		static std::string samplerFilterTypeToString(TEXTURE_SAMPLER_FILTER_TYPE filter)
        {
            switch (filter)
            {
            case TEXTURE_SAMPLER_FILTER_TYPE_NEAREST:
                return "NEAREST";
            case TEXTURE_SAMPLER_FILTER_TYPE_LINEAR:
                return "LINEAR";
            default:
                return "UNKNOWN";
            }
