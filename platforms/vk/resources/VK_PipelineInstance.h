...
namespace HBE
{
    ...
    public:
        ...
        void setTexture(uint32_t binding,ImageHandle texture, int32_t frame, uint32_t mip_level);

        void setTextureArray(uint32_t binding, ImageHandle* textures, uint32_t texture_count, int32_t frame, int32_t mip_level);
