...
namespace HBE
{
                                         ...
                                         VkRenderPass render_pass_overwrite)
    {
        ...
        VkRect2D scissor{};
        scissor.offset = {0, 0};
        scissor.extent = VkExtent2D{resolution.x, resolution.y};
        ...
        {
            pipelineInfo.renderPass = render_pass_overwrite;
        }
    ...
    VkPipeline VK_RasterizationPipeline::getHandle()
    {
        return handle;
    }
}
