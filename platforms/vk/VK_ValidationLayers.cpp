...
namespace HBE
{
    ...
    void VK_ValidationLayers::init(VkInstance instance)
    {
    ...
    void VK_ValidationLayers::release()
    {
    ...
    std::vector<VkValidationFeatureEnableEXT>& VK_ValidationLayers::getEnabledValidationFeatures()
    {
        return ENABLED_VALIDATION_FEATURES;
    }
