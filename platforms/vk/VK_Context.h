...
namespace HBE {
	...
	public:
		...
		VK_CONTEXT_MEMBER_CALL_API_FUNC(HBE_RESULT, getMeshAttributeBuffer, FUNC_PARAMS(MeshHandle handle,uint32_t location,BufferHandle& buffer_handle), FUNC_ARGS(handle,location,buffer_handle),meshes,getBuffer,FUNC_ARGS(location, buffer_handle));
		VK_CONTEXT_MEMBER_CALL_API_FUNC(HBE_RESULT, getMeshIndicesBuffer, FUNC_PARAMS(MeshHandle handle,BufferHandle& buffer_handle), FUNC_ARGS(handle,buffer_handle),meshes,getIndicesBuffer,FUNC_ARGS(buffer_handle));
		...
		VK_CONTEXT_MEMBER_CALL_API_FUNC(HBE_RESULT, setPipelineInstanceImageArray, FUNC_PARAMS(PipelineInstanceHandle handle, uint32_t binding, ImageHandle * images, uint32_t images_count, uint32_t mip_level), FUNC_ARGS(handle, binding, images, images_count, mip_level), pipeline_instances, setImageArray, FUNC_ARGS(binding, images, images_count, mip_level));
		VK_CONTEXT_MEMBER_CALL_API_FUNC(HBE_RESULT, setPipelineInstanceStorageBuffer, FUNC_PARAMS(PipelineInstanceHandle handle, uint32_t binding, BufferHandle buffer,  size_t offset), FUNC_ARGS(handle, binding, buffer, offset, frame), pipeline_instances, setStorageBuffer, FUNC_ARGS(binding, buffer, offset));
		VK_CONTEXT_MEMBER_CALL_API_FUNC(HBE_RESULT, setPipelineInstanceStorageBufferArray, FUNC_PARAMS(PipelineInstanceHandle handle, uint32_t binding, BufferHandle * buffers, uint32_t count), FUNC_ARGS(handle, binding, buffers, count), pipeline_instances, setStorageBufferArray, FUNC_ARGS(binding, buffers, count));
		VK_CONTEXT_MEMBER_CALL_API_FUNC(HBE_RESULT, setPipelineInstanceTexelBuffer, FUNC_PARAMS(PipelineInstanceHandle handle, uint32_t binding, TexelBufferHandle buffer), FUNC_ARGS(handle, binding, buffer), pipeline_instances, setTexelBuffer, FUNC_ARGS(binding, buffer));
		VK_CONTEXT_MEMBER_CALL_API_FUNC(HBE_RESULT, setPipelineInstanceTexelBufferArray, FUNC_PARAMS(PipelineInstanceHandle handle, uint32_t binding, TexelBufferHandle * buffers, uint32_t count), FUNC_ARGS(handle, binding, buffers, count), pipeline_instances, setStorageBufferArray, FUNC_ARGS(binding, buffers, count));
		VK_CONTEXT_MEMBER_CALL_API_FUNC(HBE_RESULT, setPipelineInstanceAccelerationStructure, FUNC_PARAMS(PipelineInstanceHandle handle, uint32_t binding, RootAccelerationStructureHandle acceleration_structure), FUNC_ARGS(handle, binding, acceleration_structure), pipeline_instances, setAccelerationStructure, FUNC_ARGS(binding, acceleration_structure));
		VK_CONTEXT_MEMBER_CALL_API_FUNC(HBE_RESULT, getPipelineInstanceBindingFromString, FUNC_PARAMS(PipelineInstanceHandle handle,const char *str, uint32_t&binding), FUNC_ARGS(handle, str, binding), pipeline_instances, getBinding, FUNC_ARGS(str, binding));
		...
		VK_CONTEXT_MEMBER_CALL_API_FUNC(HBE_RESULT, getRasterizationTargetFrameBuffer, FUNC_PARAMS(RasterizationTargetHandle handle,ImageHandle& image_handle), FUNC_ARGS(handle,image_handle), rasterization_targets, getFramebufferTexture, FUNC_ARGS(image_handle));
