...
namespace HBE
{
    ...
    public:
        ...
        Event<char> onCharDown = Event<char>();
        Event<vec2> onMouseRightClickDown = Event<vec2>();
        Event<vec2> onMouseRightClickUp = Event<vec2>();
        Event<vec2> onMouseRightClick = Event<vec2>();
        Event<vec2> onMouseLeftClickDown = Event<vec2>();
        ...
        bool getKeyDown(KEY code);

        float getMouseWheelInput();

        void setCursorVisible(bool visible);

        void setCursorPosition(float x, float y);

        bool getKeyUp(KEY code);
