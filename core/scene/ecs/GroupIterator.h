...
namespace HBE
{
	...
	public:
		GroupIterator(std::vector<RegistryPage*>& pages) :
			pages(pages),
		...
		GroupIterator(std::vector<RegistryPage*>& pages, ComponentTypeInfo
		...
		GroupIterator(GroupIterator&& other) : pages(other.pages)
		{
