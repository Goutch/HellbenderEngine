...
namespace HBE {
    ...
    Scene::~Scene() {
        ...
        Application::instance->onDraw.unsubscribe(draw_subscription_id);
        Application::instance->onRender.unsubscribe(render_subscription_id);
    ...
    void Scene::onFrameEnd(uint64_t frame) {
        render_graph.clear();
    }
    ...
    Scene::Scene(SceneInfo info) : context(*Application::instance->getContext()),
        ...
        Application::instance->onDraw.subscribe(draw_subscription_id, this, &Scene::draw);
        Application::instance->onRender.subscribe(render_subscription_id, this, &Scene::render);
        Application::instance->onUpdate.subscribe(update_subscription_id, this, &Scene::update);
        Application::instance->onPresent.subscribe(present_subscription_id, this, &Scene::present);
        Application::instance->onFrameEnd.subscribe(frame_change_subscription_id, this, &Scene::onFrameEnd);
    }
