...
namespace HBE
{
    ...
    {
        scene->onDraw.subscribe(on_draw_subscription_id, this, &MeshRendererSystem::onDraw);
    }
    ...
    void MeshRendererSystem::onDraw(RenderGraph* render_graph)
    {
        ...
        for (auto [handle, node, transform, mesh_renderer] : group)
        {
            ...
            if (mesh_renderer.mesh == HBE_NULL_HANDLE ||
            ...
            context.getPipelineFromInstance(mesh_renderer.pipeline_instance,draw_cmd.rasterization_pipeline_handle);
